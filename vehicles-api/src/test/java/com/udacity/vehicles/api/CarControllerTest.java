...
//      Check  the 'get' method  works by calling the whole list of vehicles.
    ...
    public void updateCar() throws Exception {
        //  update a car after it gets created
        Car car = getCar();
        mvc.perform(
                post(new URI("/cars"))
                        .content(json.write(car).getJson())
...
//      Check the 'get' method works by calling  a vehicle by ID.
...
//      Check whether a vehicle is appropriately deleted.
